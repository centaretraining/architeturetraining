...
using LegacyApp.Cart.Infrastructure;
using LegacyApp.Cart.Infrastructure.Ordering;
using LegacyApp.Web.Application.Ordering;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace LegacyApp.Web.Application.IntegrationTests
{
    [TestClass]
    public class CartServiceTests
    {
        ...
        private CartService CreateCartService()
        {
            ...
            var service = new CartService(new CartRepository(dbContext), uow);
            return service;
        }
