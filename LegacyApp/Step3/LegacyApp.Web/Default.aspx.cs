...
using LegacyApp.Web.Infrastructure.Ordering;
...
namespace LegacyApp.Web
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        public Default()
        {
            _cartService = new CartService(new OrderApiClient());
        }
        ...
        protected void MenuRepeater_OnItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            if (Session["CartId"] == null)
            {
                cartId = _cartService.CreateCart().Result;
            ...
            _cartService.AddCartItem(cartId, productId).Wait();
